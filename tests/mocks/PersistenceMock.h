...
public:
    ...
    MOCK_METHOD2(getSensorReadings, std::vector<std::shared_ptr<wolkabout::SensorReading>>(const std::string&, std::uint_fast64_t));
    ...
    MOCK_METHOD2(getAlarms, std::vector<std::shared_ptr<wolkabout::Alarm>>(const std::string&, std::uint_fast64_t count));
    MOCK_METHOD2(removeAlarms, void(const std::string&, std::uint_fast64_t count));
    MOCK_METHOD0(getAlarmsKeys, std::vector<std::string>());
    MOCK_METHOD2(putActuatorStatus, bool(const std::string&, std::shared_ptr<wolkabout::ActuatorStatus> actuatorStatus));
    ...
    MOCK_METHOD2(putConfiguration, bool(const std::string&, std::shared_ptr<std::vector<wolkabout::ConfigurationItem>> configuration));
