...
private:
	...
	static const constexpr char* MQTT_FILE_HANDING_TOPIC_ROOT = "service/commands/file/";
	static const constexpr char* URL_FILE_HANDING_TOPIC_ROOT = "service/commands/url/";
};
}
